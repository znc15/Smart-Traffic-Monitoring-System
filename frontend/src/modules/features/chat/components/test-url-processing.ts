/**
 * 用于测试 ChatInterface 中 URL 处理逻辑的测试文件
 */

// 从 ChatInterface 复制的函数
...
const test1 = "http://http//localhost:8000/api/v1/frames/文馆";
console.log("Test 1: Double http protocol");
console.log("Input:", test1);
console.log("Output:", addTokenToImageUrl(test1));
console.log(
  "Expected: http://localhost:8000/api/v1/frames/文馆?token=test-token-123\n"
);

// Test 2: Double token
const test2 =
  "http://localhost:8000/api/v1/frames/文馆?token=old-token&token=another-token";
...
// Test 3: Normal URL
const test3 = "http://localhost:8000/api/v1/frames/文馆";
...
const test4 = "http://localhost:8000/api/v1/frames/文馆?size=large";
console.log("Test 4: URL with existing params");
console.log("Input:", test4);
console.log("Output:", addTokenToImageUrl(test4));
console.log(
  "Expected: http://localhost:8000/api/v1/frames/文馆?size=large&token=test-token-123\n"
);
